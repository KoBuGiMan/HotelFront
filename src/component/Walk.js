...
function Walk() {
  const imageUrl1 = process.env.PUBLIC_URL + "/images/walk/chunggae.png";
  const imageUrl2 = process.env.PUBLIC_URL + "/images/walk/olimpic.png";
  const imageUrl3 = process.env.PUBLIC_URL + "/images/walk/namsan.png";
