...
function Park() {
  const imageUrl1 = process.env.PUBLIC_URL + "/images/park/lotte.png";
  const imageUrl2 = process.env.PUBLIC_URL + "/images/park/smurfe.png";
  const imageUrl3 = process.env.PUBLIC_URL + "/images/park/vr.png";
