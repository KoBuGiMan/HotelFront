...
function Aquarium() {
  const imageUrl1 = process.env.PUBLIC_URL + "/images/aquarium/coexe.png";
  const imageUrl2 =
    process.env.PUBLIC_URL + "/images/aquarium/lotteaquarium.png";
  const imageUrl3 = process.env.PUBLIC_URL + "/images/aquarium/jurung.png";
